...
// .wrangler/tmp/pages-WNXeG0/functionsWorker-0.5854481196202651.mjs
...
async function onRequest2(context) {
  ...
  __name2(nameToFormats, "nameToFormats");
  ...
  __name2(tryDirectCDN, "tryDirectCDN");
  ...
  __name2(tryProfilePage, "tryProfilePage");
  ...
  __name2(trySearchPage, "trySearchPage");
  ...
  __name2(resolvePerformerImage, "resolvePerformerImage");
  try {
...
async function onRequest3(context) {
  ...
  try {
    ...
    return jsonResponse2({ name, slug, photos: photos.slice(0, 30) });
  } catch (err) {
...
__name(slugToName2, "slugToName2");
__name2(slugToName2, "slugToName");
...
// .wrangler/tmp/bundle-M140aB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-M140aB/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5854481196202651.js.map
